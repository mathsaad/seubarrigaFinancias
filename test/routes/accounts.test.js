...
beforeEach(async () => {
  ...
  const result2 = await app.services.user.save({ name: 'User Account #2', mail: `${Date.now()}@mail.com`, passwd: '123456' });
  user2 = { ...result2[0] };
});
...
test('Não deve inserir uma conta com nome duplicado, para um mesmo usuário', () => { 
